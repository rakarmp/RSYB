...
int main()
{
    ...
    if (isFolderExist(folderPath))
    {
        ...
        writeToFile("/sys/devices/system/cpu/cpufreq/interactive/go_hispeed_load", "85");
        writeToFile("/sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay", "20000");
        ...
        writeToFile("/sys/devices/system/cpu/cpufreq/interactive/max_freq_hysteresis", "0");
        writeToFile("/sys/devices/system/cpu/cpufreq/interactive/align_windows", "1");
